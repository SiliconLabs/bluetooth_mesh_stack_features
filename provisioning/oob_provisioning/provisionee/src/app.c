...
#define APP_OOB_COUNTER_TIMEOUT        5000
...
void sl_btmesh_on_event(sl_btmesh_msg_t *evt)
{
  ...
  switch (SL_BT_MSG_ID(evt->header)) {
    ...
    case sl_btmesh_evt_node_display_output_oob_id:
      app_log("sl_btmesh_evt_node_display_output_oob_id\r\n");
      app_log("sl_btmesh_evt_node_display_output_oob_id: output_action 0x%.2x \r\n", evt->data.evt_node_display_output_oob.output_action);
      app_log("sl_btmesh_evt_node_display_output_oob_id: output_size 0x%.2x \r\n", evt->data.evt_node_display_output_oob.output_size);
      break;
    case sl_btmesh_evt_node_input_oob_request_id:
      app_log("sl_btmesh_evt_node_input_oob_request_id\r\n");

      app_log("sl_btmesh_evt_node_input_oob_request_id: input_action 0x%.2x \r\n", evt->data.evt_node_input_oob_request.input_action);
      app_log("sl_btmesh_evt_node_input_oob_request_id: input_size 0x%.2x \r\n", evt->data.evt_node_input_oob_request.input_size);
...
static void app_oob_counter_timer_cb(app_timer_t *handle, void *data)
{
  ...
  app_assert_status_f(sc, "Failed to send input OOB request\n");
}

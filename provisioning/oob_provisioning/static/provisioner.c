...
void bkgndBLEMeshStack(void)
{
  ...
  struct gecko_msg_mesh_prov_set_oob_requirements_rsp_t *prov_set_oob_requirements_result;
  uint16 result;
  ...
  if (pass /*&& event_is_not_deprecated(evt)*/) {
    switch (BGLIB_MSG_ID(evt->header)) {
	  ...
	  /*Set OOB settings. Only size of 1 input/putőut is authorized*/
	  prov_set_oob_requirements_result=gecko_cmd_mesh_prov_set_oob_requirements( 0
							                                                    ...
							                                                    ,1
						                                                        ,1 );
		if(0 != prov_set_oob_requirements_result->result)
		{
		  printf("gecko_cmd_mesh_prov_set_oob_requirements: failed 0x%.2x\n\r",prov_set_oob_requirements_result->result);
		}
      ...
      case gecko_evt_mesh_prov_oob_pkey_request_id:
        printf("gecko_evt_mesh_prov_oob_pkey_request_id: 0x%.2x 0x%.2x 0x%.2x 0x%.2x 0x%.2x 0x%.2x\n\r",evt->data.evt_mesh_prov_oob_pkey_request.uuid.data[0]
	                                                                                               ,evt->data.evt_mesh_prov_oob_pkey_request.uuid.data[1]
	                                                                                               ,evt->data.evt_mesh_prov_oob_pkey_request.uuid.data[2]
	                                                                                               ,evt->data.evt_mesh_prov_oob_pkey_request.uuid.data[3]
	                                                                                               ,evt->data.evt_mesh_prov_oob_pkey_request.uuid.data[4]
	                                                                                               ,evt->data.evt_mesh_prov_oob_pkey_request.uuid.data[5]);
        break;
      case gecko_evt_mesh_prov_oob_auth_request_id:
        printf("gecko_evt_mesh_prov_oob_auth_request_id: output 0x%.2x \n\r",evt->data.evt_mesh_prov_oob_auth_request.output);
        printf("gecko_evt_mesh_prov_oob_auth_request_id: output action 0x%.2x \n\r",evt->data.evt_mesh_prov_oob_auth_request.output_action);
        printf("gecko_evt_mesh_prov_oob_auth_request_id: output size 0x%.2x \n\r",evt->data.evt_mesh_prov_oob_auth_request.output_size);
        printf("gecko_evt_mesh_prov_oob_auth_request_id: UUID 0x%.2x 0x%.2x\n\r",evt->data.evt_mesh_prov_oob_auth_request.uuid.data[0],evt->data.evt_mesh_prov_oob_auth_request.uuid.data[1]);

        /* Responding to the authentication request */
        result=gecko_cmd_mesh_prov_oob_auth_rsp( out_of_band_authentication_data.len,
      ...
      case gecko_evt_mesh_prov_oob_display_input_id:
        printf("\n\rgecko_evt_mesh_prov_oob_display_input_id: action 0x%.2x \n\r",evt->data.evt_mesh_prov_oob_display_input.input_action);
        printf("gecko_evt_mesh_prov_oob_display_input_id: size 0x%.2x \n\r",evt->data.evt_mesh_prov_oob_display_input.input_size);

        /* data array */
        printf("gecko_evt_mesh_prov_oob_display_input_id: data len 0x%.2x \n\r",evt->data.evt_mesh_prov_oob_display_input.data.len);
        printf("gecko_evt_mesh_prov_oob_display_input_id: data 0x%.2x 0x%.2x 0x%.2x 0x%.2x 0x%.2x 0x%.2x 0x%.2x 0x%.2x 0x%.2x 0x%.2x 0x%.2x 0x%.2x 0x%.2x 0x%.2x 0x%.2x 0x%.2x\n\r"
        	   ,evt->data.evt_mesh_prov_oob_display_input.data.data[0]
			   ,evt->data.evt_mesh_prov_oob_display_input.data.data[1]
			   ,evt->data.evt_mesh_prov_oob_display_input.data.data[2]
			   ,evt->data.evt_mesh_prov_oob_display_input.data.data[3]
			   ,evt->data.evt_mesh_prov_oob_display_input.data.data[4]
			   ,evt->data.evt_mesh_prov_oob_display_input.data.data[5]
			   ,evt->data.evt_mesh_prov_oob_display_input.data.data[6]
			   ,evt->data.evt_mesh_prov_oob_display_input.data.data[7]
			   ,evt->data.evt_mesh_prov_oob_display_input.data.data[8]
			   ,evt->data.evt_mesh_prov_oob_display_input.data.data[9]
			   ,evt->data.evt_mesh_prov_oob_display_input.data.data[10]
			   ,evt->data.evt_mesh_prov_oob_display_input.data.data[11]
			   ,evt->data.evt_mesh_prov_oob_display_input.data.data[12]
			   ,evt->data.evt_mesh_prov_oob_display_input.data.data[13]
			   ,evt->data.evt_mesh_prov_oob_display_input.data.data[14]
			   ,evt->data.evt_mesh_prov_oob_display_input.data.data[15]);
          ...
          if( 0 > dev_idx )
          {
            ...
            for(idx=0;idx<MAX_NUM_BTMESH_DEV;idx++)
            {
                ...
                )
              {
                ...
                printf(" OOB capabilities: 0x%.2x",evt->data.evt_mesh_prov_unprov_beacon.oob_capabilities);
                printf("\n\r");
                break;
              }
            }
